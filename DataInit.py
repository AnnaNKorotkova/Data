...
# # Create Table
# cursor.execute(
#     "CREATE TABLE public.deposits (id int primary key,age varchar (50),"
#     "job varchar (50),marital varchar(50),education varchar(50),def varchar ("
#     "50),balance varchar(50),housing varchar (50),loan varchar (50),contact "
#     "varchar(50),monthes varchar(50),duration varchar (50),campaign varchar ("
#     "50),pdays varchar (50),previous varchar (50),poutcome varchar(50),"
#     "deposit  varchar(50))")
#
# conn.commit()
#
